---
name: tdd-cs
description: Test-driven development with red-green-refactor loop for C#. Use when user wants to build features or fix bugs using TDD, mentions "red-green-refactor", wants integration tests, or asks for test-first development in C#.
---
